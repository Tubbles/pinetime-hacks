...
3. **Lock screen** (verified in the field 2026-08-10; every wake source locks since 2026-09-14) — waking the watch shows the screen but rejects touch until the physical button unlocks it. A button wake comes up unlocked, and the alarm, timer expiry and an established call clear the lock so their screens stay usable. Design: `doc/DESIGN-lock-screen.md`.
